...
def is_foreground_title_contains(substring: str) -> bool:
    """True si el título de la ventana foreground contiene el substring."""
    try:
...
class HuntGifOverlay:
    """
    Overlay Tk always-on-top que muestra un GIF con borde.
    - Click derecho sostenido para arrastrar.
    - Guarda posición al soltar en save_path (json).
    """
